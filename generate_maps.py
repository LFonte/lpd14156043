...
"""
Generates graph with log locations.
...
def createMap(info):
    """
    Method generates map with location from ips as parameter.
    """
    import sys
    ...
    for x in info:
        g.maps[0].setpoint(x)
    open('_firewallLog_map.htm','wb').write(g.showhtml())   # generate test file
    pass
